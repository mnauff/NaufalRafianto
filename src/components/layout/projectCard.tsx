...
const ProjectCard: React.FC<props> = ({ detail, img, title }) => {
  return (
    <div className=' grid h-[400px] w-[300px] cursor-pointer grid-rows-2 rounded border-2 border-black border-opacity-0 bg-white bg-opacity-5 p-7 hover:border-2 hover:border-red-500 hover:shadow'>
